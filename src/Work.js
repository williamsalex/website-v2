      ...
      <div className="none">
          <div className = 'flexy'>
            <div className = 'content'>
                ...
                <a href='https://devpost.com/software/cruze' rel="noopener" target="_blank">
                    <img alt = 'devpost' className = 'icon' src = '/devpost.png'></img>
                </a>
                <a href = 'https://github.com/williamsalex/cruze' rel="noopener" target="_blank">
                ...
                <a href = 'https://devpost.com/software/direxit' rel="noopener" target="_blank">
                    <img alt = 'devpost' className = 'icon' src = '/devpost.png'></img>
                </a>
                <a href = 'https://github.com/MisterEddie/DirExit' rel="noopener" target="_blank">
                    <img alt = 'github' className = 'icon' src = '/github.png'></img>
                </a>
                <br/>
                ...
                <a href = 'https://github.com/williamsalex/Bobadilla-Conjecture' rel="noopener" target="_blank">
                    <img alt = 'github' className = 'icon' src = '/github.png'></img>
                </a>
            </div>
