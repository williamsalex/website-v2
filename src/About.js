...
export default function About() {
    return (
      <div className = 'content'>
          ...
          <p className = 'listItem'>currently backend engineer at betteryou</p>
          <p className = 'listItem'>contract web developer at valence life sciences for four months</p>
          <p className = 'listItem'>webmaster at valence life sciences for two years</p>
